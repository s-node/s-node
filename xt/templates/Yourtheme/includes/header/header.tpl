...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{$SYSTEM_LANG}" lang="{$SYSTEM_LANG}">
 <head>
  ...
  {if $smarty.get.print}
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/Yourtheme/print.css" media="screen" />
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/Yourtheme/print.css" media="print" />
  {else}
   <link rel="stylesheet" type="text/css" href="{if $TPL_CSS != ''}{$TPL_CSS}{else}{$XT_STYLES}live/Yourtheme/yourtheme.css{/if}" media="screen" />
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/Yourtheme/print.css" media="print" />
  {/if}
  <!--%%XTCSSLOADER%%-->
 ...
 <body>
  ...
  <a name="top"></a>
  <div id="container">
   <div id="header"><a href="{$smarty.server.PHP_SELF}">Home</a><br />THEME : {$THEME}</div>
   <div id="topnav">{plugin package="ch.iframe.snode.navigation" module="tree" depth=1 open_depth=1 node="10000"}</div>
   <div id="sidenav">{plugin package="ch.iframe.snode.navigation" module="tree" depth=2 start_level=2 node="10000" style="sidenav.tpl"}</div>
   <div id="content">