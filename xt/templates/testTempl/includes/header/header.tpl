...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{$SYSTEM_LANG}" lang="{$SYSTEM_LANG}">
 <head>
  ...
  {if $smarty.get.print}
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/testTempl/print.css" media="screen" />
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/testTempl/print.css" media="print" />
  {else}
   <link rel="stylesheet" type="text/css" href="{if $TPL_CSS != ''}{$TPL_CSS}{else}{$XT_STYLES}live/testTempl/testtempl.css{/if}" media="screen" />
   <link rel="stylesheet" type="text/css" href="{$XT_STYLES}live/testTempl/print.css" media="print" />
  {/if}
  <!--%%XTCSSLOADER%%-->
