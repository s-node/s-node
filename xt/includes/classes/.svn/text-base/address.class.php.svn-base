...
class XT_Address {
    ...
    */
    ...
    function index($public = true){
        ...
        $searchindex->add($this->_firstName);
        $searchindex->add($this->_lastName);
        $searchindex->add($this->_postalCode);
        $searchindex->add($this->_city);
        $searchindex->add($this->_company);
        $searchindex->add($this->_street);
        $searchindex->add($this->_email);
        $searchindex->add($this->_emailPrivate);
        $searchindex->add($this->_facsimile);
        $searchindex->add($this->_facsimilePrivate);
        $searchindex->add($this->_website);
        $searchindex->build($this->getTitle(),$this->_street
        . "<br /> " . $this->_city
        . "<br /> " . $this->_tel
        . "<br /> " . $this->_website, (0 + $this->getImage()));
        return true;
