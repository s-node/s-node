...
define("WEBROOT_DIR",       "/");	                 // web root directory
...
$cfg->set($database, "user", 		     "root"); // database user
$cfg->set($database, "pass", 		     "root"); // database password
$cfg->set($database, "database", 	     "sakan"); // database name
...
$cfg->set($system, "email", 		        "info@yourdomain.com");            // System E-Mail
$cfg->set($system, "theme", "Yourtheme");            // System Style
...
$cfg->set($system, "base_meta_description", "Beschreibung Ihrer Seite"); // Defines the Meta description base
$cfg->set($system, "base_meta_keywords",    "Schlüsselwörter, für, Ihre, Seite");    // Defines the Meta keywords base
$cfg->set($system, "base_meta_author",      "Hans Mustermann, h.mustermann@iframe.ch");      // Defines the Meta author default
$cfg->set($system, "base_meta_copyright",   "iframe AG, Widnau, Switzerland");   // Defines the Meta copyright default
$cfg->set($system, "base_meta_revisit_after",   "10 days");   // Defines  a string such as 45 days which tells the spider how often to visit the page.
$cfg->set($system, "google_analytics_key",  "");         // Google Maps Key
$cfg->set($system, "google_map_key",        "");         // Google Maps Key
$cfg->set($system, "order_nr",              5000);         // S-Node.com Order Number
...
// email preferences
$cfg->set($smtp, "Host",               "localhost");        // Default SMTP server
...
$cfg->set($smtp, "DefaultFrom",        "info@yourdomain.com" );        // SMTP sender
$cfg->set($smtp, "DefaultFromName",    "info@yourdomain.com" );        // SMTP sender name
