<?php /* Smarty version 2.6.9, created on 2011-01-21 11:10:23
         compiled from /Applications/MAMP/htdocs/s-node/xt/templates//default/ch.iframe.snode.packagebuilder/admin/licence.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', '/Applications/MAMP/htdocs/s-node/xt/templates//default/ch.iframe.snode.packagebuilder/admin/licence.tpl', 6, false),array('modifier', 'default', '/Applications/MAMP/htdocs/s-node/xt/templates//default/ch.iframe.snode.packagebuilder/admin/licence.tpl', 52, false),array('function', 'actionIcon', '/Applications/MAMP/htdocs/s-node/xt/templates//default/ch.iframe.snode.packagebuilder/admin/licence.tpl', 43, false),)), $this); ?>
...
_value[product][]" style="width:360px;" size="15" multiple/>
 <?php $_from = $this->_tpl_vars['PRODUCTS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['PRODUCT']):
?>
      <option label="<?php echo $this->_tpl_vars['PRODUCT']; ?>
" value="<?php echo $this->_tpl_vars['PRODUCT']; ?>
" <?php if ($this->_tpl_vars['SELECTEDPRODUCTS'][$this->_tpl_vars['PRODUCT']]): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['PRODUCT']; ?>
</option>  
 <?php endforeach; endif; unset($_from); ?>
 </select><?php echo actionIcon(array('form' => 'licence','action' => 'selectMini','icon' => "check.png",'title' => 'Select Mini','label' => 'Select Mini'), $this);?>
 
 <?php echo actionIcon(array('form' => 'licence','action' => 'selectAll','icon' => "check.png",'title' => 'Select All','label' => 'Select All'), $this);?>
...
<tr>
 ...
 <td class="right">
  <input type="text" name="x<?php echo $this->_tpl_vars['BASEID']; ?>
_value[limits]" value="<?php echo $this->_tpl_vars['VALUES']['limits']; ?>
">
 </td>
</tr>
</table>
