<?php /* Smarty version 2.6.9, created on 2011-01-21 10:07:35
         compiled from /Applications/MAMP/htdocs/s-node/xt/templates//default/ch.iframe.snode.navigation/tree/default.tpl */ ?>
...
?>
		<a class="nav" <?php if ($this->_tpl_vars['NAV']['target'] != ''): ?>target="<?php echo $this->_tpl_vars['NAV']['target']; ?>
...
</a>&nbsp;&nbsp;<?php if (! ($this->_foreach['N']['iteration'] == $this->_foreach['N']['total'])): ?><img style="margin-top: 1px;" src="/images/default/vertdot.gif" alt="" align="top" />&nbsp;<?php endif; ?>
